...
export const Profile = () =>{
    ...
    <Header />
        <div className=''>
        <div className="card m-50 container emp-profile">
            <form method="post">
                <div className="row">
                    ...
                    <div className="col-md-6">
                        <div className="profile-head">
                            ...
                            <ul className="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li className="nav-item">
                                    <a className={"nav-link "+(page===2?'active':'')} id="profile-tab" data-toggle="tab" role="tab" aria-controls="profile" aria-selected="false" onClick={()=>setPage(2)}>Timeline</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="row">
                    ...
                    <div className="col-md-8">
                        <div className="tab-content profile-tab" id="myTabContent">
                            <div className={"tab-pane fade " +(page===1?'show active':'')} id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <div className="row">
                                            <div className="col-md-6">
                                                <label>User Id</label>
                                            </div>
