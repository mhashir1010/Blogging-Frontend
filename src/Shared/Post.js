...
export const Post = (props) =>{
    ...
    const [postId,setPostId] =useState(0);//for opening specific comment box in feed
    ...
    return(<>
        <div className='card mb-3 rounded-12'>
            <div className="card-body">
                <div className="d-flex mb-3">
                    <a href="#!"><img src={post?.user?.image} style={{height:40+"px"}} onClick={()=>setProfileImgModal(true)} className="border rounded-circle me-2"  alt="Avatar"  /></a>
                    <div>
            ...
            <div className="bg-image hover-overlay ripple rounded-0 mx-2 text-center" data-mdb-ripple-color="light">
                <img src="https://source.unsplash.com/random" style={{height:75+'vh'}} className="img-fluid" onClick={() => setModalShow(true)}/>
                <a href="#!">
        ...
        <ProfileImage show={profileImgModal} onHide={()=>setProfileImgModal(false)}></ProfileImage>
